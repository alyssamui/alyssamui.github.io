...
export default function links() {
    return (
        <div className ="links" id="links">
            ...
            <div className="itemContainer">
                <DescriptionIcon className = "icon" onClick={event => window.location.href="https://drive.google.com/file/d/1srXddlupPnYFQHgjMQ7n8NixRGN18AfZ/view?usp=sharing"}/>
                <span onClick={event => window.location.href="https://drive.google.com/file/d/1srXddlupPnYFQHgjMQ7n8NixRGN18AfZ/view?usp=sharing"}> Resume</span>
            </div>
        </div>
    )
}
